...
import { useTransform, motion, useScroll, MotionValue } from 'framer-motion'; // Исправленный импорт
...
const BoardofDirectors = () => {
  ...
  return (
    <ReactLenis root>
      <div ref={container} className="board-of-directors-container">
        <h2 className="text-2xl font-bold text-center mb-6">Совет директоров</h2>
